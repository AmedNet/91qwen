  ...
  <main class="main-content">
    <div class="page-header">
      ...
      <div class="page-header-right">
        <span class="uptime-text">运行时间: <span id="headerUptime">—</span></span>
      </div>
    </div>
    ...
    <div class="overview-grid">
      <div class="overview-left">
        ...
        <div class="kpi-grid" id="kpiGrid">
          <div class="kpi-card"><span class="kpi-label">总账户数</span><span class="kpi-value" id="kpiTotalAccounts">—</span><span class="kpi-sub" id="kpiTotalAccountsSub"></span></div>
          ...
          <div class="kpi-card"><span class="kpi-label">排队数</span><span class="kpi-value" id="kpiQueue">—</span><span class="kpi-sub" id="kpiQueueSub"></span></div>
          ...
          <div class="kpi-card"><span class="kpi-label">运行时间</span><span class="kpi-value" id="kpiUptime">—</span><span class="kpi-sub" id="kpiUptimeSub"></span></div>
        </div>
          ...
          <div class="panel-body open">
            <div class="panel-content">
              <div class="pool-grid" id="poolGrid">
                <div class="pool-stat"><div class="pool-stat-value" id="poolActive">—</div><div class="pool-stat-label">活跃</div></div>
                ...
                <div class="pool-stat"><div class="pool-stat-value" id="poolTotal">—</div><div class="pool-stat-label">总计</div></div>
              </div>
        ...
        <!-- Model Health -->
        <div class="panel">
          <div class="panel-header open" onclick="togglePanel(this)"><span class="panel-title">模型健康</span><span class="panel-chevron">▼</span></div>
          <div class="panel-body open">
            <div class="panel-content">
              <div class="tbl-wrap">
                <table id="modelTable">
                  <thead><tr><th>模型</th><th>成功</th><th>错误</th><th>成功率</th><th>最后活动</th></tr></thead>
