...
<div class="dashboard-layout">
  ...
  <main class="main-content">
          ...
          <div class="mode-comparison" id="modeComparison">
            <div class="mode-card">
              ...
              <div class="mode-stats">
                ...
                <div class="mode-stat"><div class="mode-stat-value" id="modeStrErrors">—</div><div class="mode-stat-label">错误</div></div>
            ...
            <div class="mode-card">
              ...
              <div class="mode-stats">
                ...
                <div class="mode-stat"><div class="mode-stat-value" id="modeNsErrors">—</div><div class="mode-stat-label">错误</div></div>
    ...
    <div class="panel">
      <div class="panel-header open" onclick="togglePanel(this)"><span class="panel-title">按账户统计</span><span class="panel-chevron">▼</span></div>
      <div class="panel-body open">
        <div class="panel-content">
          ...
          <div class="monitor-table-wrap" id="acctTableWrap">
            <div class="empty-monitor" id="emptyMonitor">
              ...
              <h3>暂无监控数据</h3>
              <p>数据将在账户开始响应请求后出现。<br>每条请求都会记录延迟、模式和成功状态。</p>
            </div>
    ...
    <!-- Error Summary -->
    <div class="panel">
      <div class="panel-header open" onclick="togglePanel(this)"><span class="panel-title">常见错误</span><span class="panel-chevron">▼</span></div>
      <div class="panel-body open">
        <div class="panel-content">
